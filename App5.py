...
cement = st.number_input("Cement (kg/m3) ["Range: 0 – 400 kg/m³"]",min_value=0.0,max_value=400.0, value=300, step=1, format="%d")
fly_ash = st.number_input("Fly Ash (kg/m3) ["Range: 0 – 400 kg/m³"]",min_value=0.0,max_value=400.0, value=50,step=1, format="%d")
slag = st.number_input("Slag (kg/m3) ["Range: 0 – 400 kg/m³"]",min_value=0.0,max_value=400.0, value=50, step=1, format="%d")
water = st.number_input("Water (kg/m3) ["Range: 100 – 250 kg/m³"]",min_value=100.0,max_value=250.0, value=180, step=1, format="%d")
hrwr = st.number_input("HRWR (kg/m3)", value=0, step=1, format="%d")
coarse = st.number_input("Coarse Aggregates (kg/m3) ["Range: 500 – 2000 kg/m³"]",min_value=500.0,max_value=2000.0, value=900, step=1, format="%d")
fine = st.number_input("Fine Aggregate (kg/m3) ["Range: 500 – 1000 kg/m³"]",min_value=500.0,max_value=1000.0, value=700, step=1, format="%d")
